...
exports.mediaSetup = (ogObject, options) => {
  ...
  const ogImages = _.zip(ogObject.ogImage,
  ...
  const ogVideos = _.zip(ogObject.ogVideo,
  ...
  const twitterImages = _.zip(ogObject.twitterImage,
    ogObject.twitterImageWidth,
    ogObject.twitterImageHeight,
    ogObject.twitterImageAlt)
  ...
  const twitterPlayers = _.zip(ogObject.twitterPlayer,
    ogObject.twitterPlayerWidth,
    ogObject.twitterPlayerHeight,
    ogObject.twitterPlayerStream)
  ...
  const musicSongs = _.zip(ogObject.musicSong,
